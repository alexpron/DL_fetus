...
class BasicDataset(Dataset):
    def __init__(self, imgs_dir, masks_dir, scale, num_classes):
    ...
    def get_augmentation(cls, image, mask, min_pix_img, min_pix_mask):
        ...
        #print('shape mask 2: '+str(mk_t.shape))
        msk_aug = mk_t.cpu().numpy()
        #print('shape mask 3: '+str(msk_aug.shape))
        return img_aug, msk_aug.squeeze()

...
dir_img = '../Data/drawem9_2/imgs_2D/'
dir_mask = '../Data/drawem9_2/mask_2D/'
dir_checkpoint = 'checkpoints_b32_drawem9_2_test/'
...
def train_net(net,
    ...
    with open('../metric_evaluation_b32_drawem9_2.csv', 'w', newline='') as csvfile:
